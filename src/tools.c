...
char** compile_prefix(char* table_prefix){
    ...
    char* table_prefixcpy = (char*) malloc(strlen(table_prefix) + 1);
    strcpy(table_prefixcpy, table_prefix);
    table_prefixcpy[strlen(table_prefix)] = '\0';
    ...
    char* delim = ".";
    char* dbname = strtok(table_prefixcpy, delim);
